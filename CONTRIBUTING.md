...
If you believe you have found an issue with the code please do not hesitate to file an issue in [Github](https://github.com/davron112/lura/issues). When
...
2. [Fork the project](https://github.com/davron112/lura/fork_select)
...
using the following command:
    ...
    git remote add upstream https://github.com/davron112/lura.git
